...
const dogJumbotron = (props) => {
    return (
        <div>
          ...
          <Col sm="4"><div className= "text-center" style={{borderColor: "transparent", backgroundColor: "transparent"}} ><img style={{width: 150, height: 150, paddingLeft: -10}}src={require('../Emoji/assets/images/doginjailonbackground.png')} alt="dog cage"/></div></Col>
        </Row>
